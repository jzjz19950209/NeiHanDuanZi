...
public class CustomShapeImageView extends ImageView {
    ...
    public CustomShapeImageView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray ta = context.obtainStyledAttributes(attrs, org.lenve.customshapeimageview.R.styleable.CustomShapeImageView);
        shape = ta.getInt(org.lenve.customshapeimageview.R.styleable.CustomShapeImageView_shape, TYPE_CIRCLE);
        corner = ta.getDimensionPixelSize(org.lenve.customshapeimageview.R.styleable.CustomShapeImageView_corner, 5);
        rotate = ta.getInt(org.lenve.customshapeimageview.R.styleable.CustomShapeImageView_rotate, 0);
        ta.recycle();
        paint = new Paint();
